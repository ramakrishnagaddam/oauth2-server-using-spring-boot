package app.web.ramakrishnagaddam.oauth.utils;
...
public class KeyUtils {
	...
	@Value("${app.access-token.private}")
	private String accessTokenPrivateKeyPath;
	
	@Value("${app.access-token.public}")
	private String accessTokenPublicKeyPath;
	
	@Value("${app.refresh-token.private}")
	private String refreshTokenPrivateKeyPath;
	
	@Value("${app.refresh-token.public}")
